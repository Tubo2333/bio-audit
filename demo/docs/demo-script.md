...
> **窗口**：N-e（execution-plan §六.十八 N-e 13）｜**日期**：2026-08-19
> **依据**：demo-redesign-design v0.3 §2（目标/观众）、§3.2（推荐轨迹清单与默认路径）、
> §12（留实现窗口处理：PMID 断网纪律 / 63.7 vs 66.7 话术 / 预热纪律）+ 台账 §5 收口。
...
*讲稿产物：N-e 窗口（2026-08-19）。默认演示路径与工坊页「恢复演示默认态」语义一致，
